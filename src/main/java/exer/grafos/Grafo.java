...
public class Grafo {
    ...
    // Retorna o TAMANHO do grafo (quantidade de arestas)
    ...
    private Aresta criaAresta(String nomeAresta, String nomeVertice1, String nomeVertice2) {
        ...
        // --- Atualização das Adjacências nos Vértices ---
        // v1 envia aresta para v2 (logo, v2 entra na lista de adjacências de v1)
        v1.adicionarAdjacencia(v2);
        // v2 recebe aresta de v1 (logo, v1 entra na lista de adjacentes de v2)
        v2.adicionarAdjacente(v1);
    ...
    public String toString() {
        return """
                Grafo{
                   ...
                   vertices = %s,
                   arestas = %s
                }""".formatted(getOrdem(), getTamanho(), eDirigido ? "sim" : "não", vertices, arestas);
    }
}